...
- **Claude / ChatGPT**: Utilized for debugging the `IntersectionObserver` JavaScript logic and explaining complex concepts like semantic HTML and responsive design. They also helped structure the comprehensive technical documentation.
